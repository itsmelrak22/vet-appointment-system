    ...
    <div class="accordion-item">
      ...
      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
          <p>It enables you to have a real-time consultation via video conferencing technology using your smartphone, tablet, laptop, or PC at your comfort home with your pet. This method is only available if the doctor wishes to..</p>
        </div>
      </div>
    </div>
    <div class="accordion-item">
      <h3 class="accordion-header" id="headingTwo">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
          What is the benefit of virtual consultation?
        </button>
      </h3>
